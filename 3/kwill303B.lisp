...
(defparameter *objects* '(bucket bundle-of-napkins chain container-of-pringles eggplant frog lunch-bag tacos whiskey))
...
(defparameter *object-locations* '((whiskey living-room)
                                   ...
                                   (eggplant dumpster)
                                   (chain garden)
                                   (lunch-bag living-room)
                                   (container-of-pringles attic)
                                   (bundle-of-napkins dumpster)
                                   (tacos garden)
                                   (frog garden)))
